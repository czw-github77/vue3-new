<template>
    <ul class="listItem">
        <template v-for="section in itemJson">
            <!-- 视频 -->
            <li v-if="section.playonlineurl" :key="section.playonlineurl">
            ...
            <!-- 1张大图 -->
            <li v-else-if="section.ptitlepic" :key="section.ptitlepic">
            ...
            <!-- 3张小图 -->
            <li v-else-if="section.titlepic3" :key="section.titlepic3">
            ...
            <!-- 1张小图 -->
            <li v-else-if="section.titlepic" :key="section.titlepic">
             ...
             <!-- 文字 -->
            <li v-else-if='section.title' :key="section.title">
                <router-link :to="url(section)" class='text'>
                    <h3 v-html="section.title"></h3>
                    <list-info :json='section'></list-info>
                </router-link>
            </li>
            <li v-else-if='section.type' id="lookHere" :key="section.type">
