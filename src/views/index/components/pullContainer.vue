<template>
    ...
    <div class="container"
        ...
        <!-- 下拉加载 -->
        <mt-loadmore :top-method="loadTopAjax"
            ...
            <div slot="top"
                ...
                <span v-show="topStatus == 'pull'"><img class='pullLoading'
                        src="~@/assets/img/loading.png"> 下拉刷新↓</span>
                <span v-show="topStatus == 'drop'"><img class='pullLoading'
                        src="~@/assets/img/loading.png"> 释放更新↑</span>
                <span v-show="topStatus == 'loading'"><img class='pullLoading'
                        src="~@/assets/img/loading.gif"> 加载中...</span>
            </div>
            <!-- banner组件 -->
            <my-banner :json="bannerJson"
                v-if='bannerJson.length > 0' />
            <!-- 置顶组件 -->
            <list-item :itemJson="stickJson"
                v-if='stickJson.length > 0' />
            <!-- listItem -->
            ...
            <div class="bottomLoad"
                v-if="contentJson.length > 0">
                <div class="loading"
                    v-show='bottomLoading'>加载中...</div>
                <div class="noData"
                    v-if='bottomNoData'>没有更多的内容了</div>
            </div>
        </mt-loadmore>
    </div>
</template>
